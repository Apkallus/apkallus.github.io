...
- 开启配置缩放设置
- 浏览器的代理设置中添加排除项 ```firefox.com, mozilla.com, mozilla.net, mozilla.org, darkreader.org, bing.com, googleapis.com, linkedin.com, youtube.com, portswigger.net, google.com```
